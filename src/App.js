...
function App() {
 const[delivery,setDelivery]=useState();
  ...
  <div className='top_select'> 
     ...
     <span className='top_category'>Обувь<img width={30} height={30} src="img/arrow-right.svg"></img> Мужская обувь</span>
          <div className='main_select'><h1>Кеды и слипоны мужские</h1> <span>20 826 товаров</span></div>
